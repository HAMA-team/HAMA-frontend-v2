          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span
                ...
                style={{
                  color: request.action === "buy" ? "#3b82f6" : "#ef4444",
                }}
              >
            ...
            >
              ...
              <span className="text-base font-semibold" style={{ color: "#171717" }}>
